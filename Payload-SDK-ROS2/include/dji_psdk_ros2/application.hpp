...
class Application {
public:
    Application(std::string config_json_path, std::string log_path);
    ~Application();

private:
    void DjiUser_SetupEnvironment();
    ...
    static T_DjiReturnCode DjiUser_LocalWriteFsInit(std::string log_path);
