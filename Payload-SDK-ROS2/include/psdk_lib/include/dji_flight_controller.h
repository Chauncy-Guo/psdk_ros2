 ...
 * @note Only when the GPS signal is goodDJI_FLIGHT_CONTROLLER_VERTICAL_VELOCITY_CONTROL_MODE (health_flag >=3)，horizontal position control (DJI_FLIGHT_CONTROLLER_HORIZONTAL_POSITION_CONTROL_MODE)
