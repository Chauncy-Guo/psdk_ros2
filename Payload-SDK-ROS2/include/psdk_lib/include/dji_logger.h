...
#define GET_CURRENT_TIME_WITH_MS(time_str, size) do { \
struct timeval tv; \
...
#define USER_LOG_DEBUG(fmt, ...)    \
        ...
        DjiLogger_UserLogOutput(DJI_LOGGER_CONSOLE_LOG_LEVEL_DEBUG, "[%s %s:%d) " fmt, time_str, __FUNCTION__, __LINE__, ##__VA_ARGS__); \
        } while(0)
...
#define USER_LOG_INFO(fmt, ...)     \
        ...
        char time_str[128]; \
        GET_CURRENT_TIME_WITH_MS(time_str, sizeof(time_str)); \
        DjiLogger_UserLogOutput(DJI_LOGGER_CONSOLE_LOG_LEVEL_INFO, "[%s %s:%d) " fmt, time_str, __FUNCTION__, __LINE__, ##__VA_ARGS__); \
        } while(0)
...
#define USER_LOG_WARN(fmt, ...)     \
        ...
        char time_str[128]; \
        GET_CURRENT_TIME_WITH_MS(time_str, sizeof(time_str)); \
        DjiLogger_UserLogOutput(DJI_LOGGER_CONSOLE_LOG_LEVEL_WARN, "[%s %s:%d) " fmt, time_str, __FUNCTION__, __LINE__, ##__VA_ARGS__); \
        } while(0)
...
#define USER_LOG_ERROR(fmt, ...)    \
        ...
        char time_str[128]; \
        GET_CURRENT_TIME_WITH_MS(time_str, sizeof(time_str)); \
        DjiLogger_UserLogOutput(DJI_LOGGER_CONSOLE_LOG_LEVEL_ERROR, "[%s %s:%d) " fmt, time_str, __FUNCTION__, __LINE__, ##__VA_ARGS__); \
        } while(0)
